...
//    }
    @ApiOperation(value = "returns all workouts for specific user", response = User.class, responseContainer = "List")
    @GetMapping(value = "/userworkout",
                produces = {"application/json"})
    public ResponseEntity<?> listAllWorkoutsForUser(Authentication authentication, HttpServletRequest request)
    {
