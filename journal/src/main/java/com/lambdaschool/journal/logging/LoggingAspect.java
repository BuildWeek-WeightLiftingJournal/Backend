package com.lambdaschool.journal.logging;
...
{
    @Around(value = "@within(com.lambdaschool.journal.logging.Loggable) || @annotation(com.lambdaschool.journal.logging.Loggable)")
